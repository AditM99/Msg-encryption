...
def DisplayImageEncrypted1():
    imgEncrypt1 = Image.open('C:\\Users\\Adit\\Desktop\\gui\\ImageEncrypted1.jpg')
...
def DisplayImageEncrypted2():
    imgEncrypt2 = Image.open('C:\\Users\\Adit\\Desktop\\gui\\ImageEncrypted2.jpg')
...
def DisplayImageDecrypted1():
    imgDecrypt1 = Image.open('C:\\Users\\Adit\\Desktop\\gui\\ImageDecrypted1.jpg')
...
def DisplayImageDecrypted2():
    imgDecrypt2 = Image.open('C:\\Users\\Adit\\Desktop\\gui\\ImageDecrypted2.jpg')
...
def ReadMessageTxt():
    # print("abc")
    # with open("C:\\Users\\Adit\\Desktop\\gui\\HiddenMessage.txt ","r") as f:
    # decryptedMessage = ast.literal_eval(f.read())
...
# btn = Button(root, text ='Open Image', command = open_img).grid(row = 1)
...
encryptButton1 = Button(root, text='Encrypt Method 1', command= lambda:[encrypt1(), DisplayImageEncrypted1()])
encryptButton1.grid(row = 6, column = 1)
encryptButton2 = Button(root, text='Encrypt Method 2', command= lambda:[encrypt2(), DisplayImageEncrypted2()])
...
decryptButton1 = Button(root, text='Decrypt Method 1', command= lambda:[decrypt1(), DisplayImageDecrypted1()])
decryptButton1.grid(row = 11, column = 1)
decryptButton2 = Button(root, text='Decrypt Method 2', command= lambda:[decrypt2(), DisplayImageDecrypted2()])
decryptButton2.grid(row = 11, column = 2)

emptyLabel5 = Label(text = "                           ")
emptyLabel5.grid(row = 13, column=1)

GetHiddenMessage = Button(root, text='Get Hidden Message', command= ReadMessageTxt)
